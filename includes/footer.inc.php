...
<footer class="footer">
  <div class="footer-left">
    <a href="./index.php"><img src="./assets/images/logo.jpeg" /></a>
    <p>
      The collection point of world news. A one stop shop. We bring to you the current happenings around the world from
      esteemed writers. Make sure to read up and keep up with us through this platform that we bring to you. Nova News
    </p>
    <div class="socials">
  ...
  <ul class="footer-right">
    ...
    <li>
      ...
      <ul class="box">
        <li>
          Share the story in your own words with the world. To Inspire with your writing make Nova News your platform to
  ...
  <div class="footer-bottom">
    <p>All Rights Reserved by &copy; Nova News<?php echo date("Y")?></p>
  </div>
</footer>
